...
class Strings {
  ...
  static const youHaveNoPosts =
      'You have not made a post yet. Press either the video-upload or the photo-upload button to the top of the screen in order to upload your first post!';
  ...
  static const enterYourSearchTerm =
      'Enter your search term in order to get started. you can search in description of all posts available in the system';
